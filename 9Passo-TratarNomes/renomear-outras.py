...
def renomear_questoes_simples():
    pasta = "101-180" # ATUALIZAR com o nome da pasta das questões que você vai arrumar (ex: 80-90, 15, 28)
    ...
    for i in range(178, 181+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
        antigo = f"questao-{i}.png"
        #novo = f"questao-{i+92}-espanhol.png"  # faça uma conta: se a primeira pagina for 
        #novo = f"questao-{i+89}-ingles.png"
